	...
	def inRange(self,pos1,pos2):
		...
		for i in range(len(self.pos)):
			...
			if int(self.pos[0])>=int(pos1) and int(self.pos[0])<int(pos2):
				parcours = True
				#print("condition1")
				#print(self.pos.list_position[0],self.pos.list_position[1],"\t",pos1,pos2)
				

			elif int(self.pos[1])>int(pos1) and int(self.pos[1])<=int(pos2):
				parcours= True
				#print(self.pos.list_position[i][1],"\t",pos1,pos2)
